...
describe('Inline Documents Endpoints', () => {
    ...
    describe('listInlineDocuments', () => {
        ...
        it('should filter by project_id', async () => {
            ...
            expect(mockedDb.query).toHaveBeenCalledWith(expect.any(String), expect.arrayContaining([1, 1]));
        });
    ...
    describe('updateInlineDocument', () => {
        ...
        it('should include change_summary', async () => {
            ...
            expect(result.success).toBe(true);
            expect(mockedDb.execute).toHaveBeenCalledWith(expect.any(String), expect.arrayContaining(['Updated content']));
        });
    ...
    describe('deleteInlineDocument', () => {
        it('should soft delete marks inactive', async () => {
            ...
            expect(mockedDb.execute).toHaveBeenCalledWith(expect.stringContaining('is_active = 0'), [1]);
        });
        it('should return 404 for non-existent document', async () => {
            mockedDb.query.mockResolvedValueOnce([]);
            const result = await deleteInlineDocument.execute({
    ...
    describe('searchDocuments', () => {
        ...
        it('should perform case insensitive search', async () => {
            ...
            expect(result.success).toBe(true);
            expect(mockedDb.query).toHaveBeenCalledWith(expect.any(String), expect.arrayContaining(['%api%', '%api%']));
        });
...
//# sourceMappingURL=inline-documents.test.js.map