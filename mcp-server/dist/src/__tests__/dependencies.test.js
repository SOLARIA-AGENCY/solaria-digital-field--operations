...
const { addDependency, removeDependency, getDependencies, detectDependencyCycles, getBlockedTasks } = await import('../endpoints/dependencies.js');
describe('Task Dependencies Endpoints', () => {
    ...
    describe('add_dependency', () => {
        ...
        it('should support different dependency types', async () => {
            const types = ['blocks', 'requires', 'related', 'child_of'];
