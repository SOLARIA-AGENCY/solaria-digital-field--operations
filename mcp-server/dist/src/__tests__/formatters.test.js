...
import { formatTask, formatTaskList, formatTaskSummary, formatProject, formatProjectList, formatAgent, formatAgentList, formatSprint, formatSprintList, formatCapabilities, formatTable, formatDuration, formatPercentage, formatProgressBar, Formatters, } from '../utils/formatters';
    ...
    describe('formatTaskList', () => {
        it('should format multiple tasks', () => {
            const tasks = [
                ...
                { ...mockTask, task_code: 'DFN-002', status: 'in_progress', progress: 50 },
            ];
...
describe('Agent Formatters', () => {
    ...
    describe('formatAgentList', () => {
        it('should format multiple agents', () => {
            const agents = [
                mockAgent,
                { ...mockAgent, id: 5, name: 'Backend Architect', status: 'inactive' },
            ];
...
describe('Sprint Formatters', () => {
    ...
    describe('formatSprintList', () => {
        it('should format multiple sprints', () => {
            const sprints = [
                mockSprint,
                { ...mockSprint, sprint_number: 2, status: 'planned' },
            ];
