...
case "$ENV" in
    claude_code)
        ...
        echo ""
        echo -e "  ${YELLOW}IMPORTANT - Project Isolation:${NC}"
        echo "  When starting work, the AI agent MUST call:"
        echo ""
        echo "    set_project_context({project_name: \"${PROJECT_NAME}\"})"
        echo ""
        echo "  This isolates the session to this project only."
        echo "  Without this, the agent might see data from other projects."
        echo ""
        echo "  Available tools:"
        echo "    - set_project_context  (CALL FIRST!)"
        echo "    - get_current_context"
    ...
    cursor)
        ...
        echo ""
        echo -e "  ${YELLOW}IMPORTANT - Project Isolation:${NC}"
        echo "  The AI agent must call set_project_context first!"
        ;;
    windsurf)
...
echo ""
echo -e "${ORANGE}╔═══════════════════════════════════════════════════════════════╗${NC}"
echo -e "${ORANGE}║           Multi-Agent Project Isolation                        ║${NC}"
echo -e "${ORANGE}╚═══════════════════════════════════════════════════════════════╝${NC}"
echo ""
echo "When multiple AI agents work on different projects simultaneously,"
echo "each agent MUST establish their project context at session start:"
echo ""
echo -e "  ${BLUE}set_project_context({project_name: \"${PROJECT_NAME}\"})${NC}"
echo ""
echo "This ensures:"
echo "  - Agent only sees tasks from this project"
echo "  - New tasks are created in this project"
echo "  - No cross-project data contamination"
echo ""
echo "The agent can verify isolation with:"
echo ""
echo -e "  ${BLUE}get_current_context()${NC}"
echo ""
