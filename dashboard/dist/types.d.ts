...
export type ExpressHandler = (req: AuthenticatedRequest, res: Response, next?: NextFunction) => void | Promise<void>;
export type ExpressMiddleware = (req: AuthenticatedRequest, res: Response, next: NextFunction) => void | Promise<void>;
...
export interface CFODashboard {
    ...
    projects: Array<ProjectWithStats & {
